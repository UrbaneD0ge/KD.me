    ...
    <div className="App">
      <main id='work' className="row">
        ...
        <div className="col s12 m6 l6 project">
          <div className="card medium">
            <div className="card-image waves-effect waves-block waves-light">
              <a href='https://npu-cards-svelte.vercel.app/' rel='noreferrer noopener' target='_blank'>
                <img className='demoPic' alt="Musical Time Machine"
                  src="https://github.com/UrbaneD0ge/NPU-Cards-svelte/assets/88916382/35cc541b-5ebd-45c8-99ff-8b478748d0c5"></img></a>
            </div>
            <div className="card-action">
              <h2 className="card-title">NPU Locator</h2>
              <a href="https://github.com/UrbaneD0ge/NPU-Cards-svelte" target='_blank' rel="noreferrer" alt="Project Repo Link">View Repo</a>
              <p>My first complete Svelte project, the NPU Locator fills a need for a robust yet lightweight lookup tool.</p>
            </div>
          </div>
        </div>
        ...
        <div className="col s12 m6 l6 project">
          <div className="card medium">
            <div className="card-image waves-effect waves-block waves-light">
              <a href="https://coaplangis.maps.arcgis.com/apps/dashboards/1f96df45f3444796a0d73efbf18df677" rel='noreferrer noopener' target='_blank'>
                <img className='demoPic'
                  src="https://github.com/UrbaneD0ge/NPU-Cards-svelte/assets/88916382/7d57f105-fcbd-4a5d-a40a-7d6378708544" alt="Agendenator" ></img></a>
            </div>
            <div className="card-action">
              <h2 className="card-title">NPU GIS Dashboard</h2>
              <a href="https://coaplangis.maps.arcgis.com/home/item.html?id=1f96df45f3444796a0d73efbf18df677" target='_blank' rel="noreferrer">View Description</a>
              <p>A public table of 2023 NPU Applications. Built on the ArcGIS Dashboard platform, customized with <a href="https://developers.arcgis.com/arcade/">ARCade</a></p>
            </div>
          </div>
        </div>
          ...
          <div className="card medium">
            <div className="card-image waves-effect waves-block waves-light">
              <a href='https://urbaned0ge.github.io/NPUNGL0Tron-2/' rel='noreferrer' target='_blank'>
                <img className='demoPic'
                  src="https://github.com/UrbaneD0ge/NPUNGL0Tron-2/assets/88916382/d9c8556e-f262-4747-b0ac-f13b6fa54e10" alt="NPUNGL0Tron-2"></img></a>
            </div>
            <div className="card-action">
              <h2 className="card-title">NPUNGLR-2</h2>
