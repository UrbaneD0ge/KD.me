function AboutMe() {
    return (
        <div id="Bio" className='row'>
            <div className='s12 m12 l12 card horizontal'>
                ...
                <div id="pictureFrame" className='card-image valign-wrapper'>
                    <img id="portrait" src="https://i.ibb.co/9twjYxJ/00100l-PORTRAIT-00100-BURST20190919181515033-COVER-2.jpg"
                        alt="I'm an okra pod." />
                </div>
            </div>
        </div>
