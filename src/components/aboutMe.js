function AboutMe() {
    return (
        <section id="AboutMe" className="About Me">
            <h2>About Me</h2>
            <img id="portrait" className="align-self-start" src="https://i.ibb.co/9twjYxJ/00100l-PORTRAIT-00100-BURST20190919181515033-COVER-2.jpg" height="300vh" alt="I'm an okra pod."/>
